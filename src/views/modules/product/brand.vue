<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="logo" header-align="center" align="center" width="200" label="品牌logo地址">
...
<!--            fit="cover"></el-image>-->
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="250" label="操作">
        <template slot-scope="scope">
<!--          一个品牌对应多个分类，多对多-->
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.brandId)">关联分类</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      updateBrandStatus(data){
        console.log("updateBrandStatus最新信息",data)
